...
# Neste exemplo estamos zerando os valores RED e GREEN, mantendo somente o valor original do BLUE. 
def resize_image_rgb(pixels):
    new_pixels = []
    for i in range(0, len(pixels), 3):
        r, g, b = 0, 0, pixels[i] #Para manter o BLUE
        # r, g, b = 0, pixels[i], 0 Para manter o GREEN
        # r, g, b = pixels[i], 0, 0 Para manter o RED
